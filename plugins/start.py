...
async def start_command(client: Client, message: Message):
    ...
    if len(text)>7:
        ...
        try:
            ...
            await message.reply_text("Uppss, Sepertinya Ada Yang Keban")
            return
...
async def not_joined(client: Client, message: Message):
    buttons = [
        [
            InlineKeyboardButton(text="Bergabung Channel", url=client.invitelink1),
            InlineKeyboardButton(text="Bergabung Channel", url=client.invitelink2),
        ]
    ]
    try:
        buttons.append(
