...
async def channel_post(client: Client, message: Message):
    reply_text = await message.reply_text("Medianya Sedang Loading....", quote = True)
    try:
        ...
        print(e)
        await reply_text.edit_text("Medianya Sedang Loading....")
        return
    ...
    await reply_text.edit(f"<b>Link Nonton Medianya Klik Dibawah ...</b>\n\n{link}", reply_markup=reply_markup, disable_web_page_preview = True)
